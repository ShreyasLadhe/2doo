...
export function HomeHero({ sx, ...other }) {
  ...
  const renderText = () => (
    <m.div {...motionProps}>
      ...
      >
        {`Minimalistic and lightweight, it helps you stay focused and get things done.\n Remove all the complex todo applications fuss and try out 2DOO today for free!`}
      </Typography>
    </m.div>
  );
